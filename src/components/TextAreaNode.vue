  ...
  <div class="text-node doc-node">
    ...
    <section class="doc-node__body">
      <textarea
        ...
        :placeholder="props.data?.placeholder ?? 'Type here…'"
        spellcheck="true"
...
<style scoped>
.text-node { overflow: visible; } /* lets Grammarly popovers escape the box */
...
.text-node__textarea {
  ...
  font: inherit;
  line-height: 1.45;
  resize: vertical;         /* user can grow it; Grammarly likes native textareas */
}
